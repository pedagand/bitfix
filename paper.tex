...
\begin{abstract}
  ...
  code transformation, such as bitslicing and fixslicing. Our work
  rests on a Coq development providing the specification of two
  ciphers, Skinny and Gift, deriving a bitsliced and fixsliced
  implementation for each and proving their correctness with respect
...
aaccompanying source code~\footnote{\url{TODO}}. For clarity, we shall
