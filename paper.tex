...
rotation operators for any foldable functor \coqe!T! Naperian
over a type \coqe!Ix!:
%
...
looking find 4 simplified implementations, inspired
by~\citet{adominicai:fixslicing-gift}. Only later did we use Coq to
understand how these solutions \emph{could} have been derived from
first principles.}, which consists in using Coq as a term rewriting
engine, is to postulate the existence of such an explicit form, let us
call it
%
